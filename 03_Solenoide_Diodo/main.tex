...
\begin{figure}[H]
    \centering
    %\includegraphics[width=0.8\textwidth]{Misc/Schema_Collegamento.png}
    \caption{INSERIRE INSERIRE Schema del collegamento dei componenti per il pilotaggio del solenoide.}
